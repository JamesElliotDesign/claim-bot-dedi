    ...
    try {
       ...
       // 🟢 "Claim POI"
        ...
        if (claimMatch) {
            ...
            // ✅ Claim the POI
            CLAIMS[correctedPOI] = {
                player: normalizedClaimant,          // for logic
                displayName: playerName.trim(),      // for display
                timestamp: Date.now(),
                members: [{
            ...
            // Get display names from players currently in the group
